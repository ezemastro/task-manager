...
app.get('/api/stage-templates', (req: Request, res: Response) => {
  const sql = `
...
app.get('/api/stage-templates/:id', (req: Request, res: Response) => {
  const { id } = req.params;
  const sql = `
    SELECT st.*, u.name as default_responsible_name 
    FROM stage_templates st
...
app.post('/api/stage-templates', (req: Request, res: Response) => {
...
app.put('/api/stage-templates/:id', (req: Request, res: Response) => {
  const { id } = req.params;
  const { name, order_number, default_responsible_id, estimated_duration_days } = req.body;
...
app.delete('/api/stage-templates/:id', (req: Request, res: Response) => {
  const { id } = req.params;
...
// Completar una etapa
app.put('/api/stages/:id/complete', (req: Request, res: Response) => {
  const { id } = req.params;
...
app.put('/api/stages/:id', (req: Request, res: Response) => {
  const { id } = req.params;
...
// Eliminar una etapa
app.delete('/api/stages/:id', (req: Request, res: Response) => {
  const { id } = req.params;
...
app.post('/api/stages/:id/tags', (req: Request, res: Response) => {
  const { id } = req.params;
...
app.delete('/api/stages/:stageId/tags/:tagId', (req: Request, res: Response) => {
...
app.get('/api/stages/:stageId/comments', (req: Request, res: Response) => {
